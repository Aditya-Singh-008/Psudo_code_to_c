...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_input_stmt = 30                 /* input_stmt  */
};
...
{
       0,    53,    53,    53,    59,    59,    63,    63,    63,    63,
      67,    75,    81,    86,    89,    90,    91,    92,    93,   101,
     102,   110
};
#endif
...
static const char *const yytname[] =
{
  ...
  "AS", "INT", "SET", "TO", "SHOW", "GET", "PLUS", "MINUS", "MULT", "DIV",
  "NUMBER", "IDENTIFIER", "STRING", "'('", "')'", "$accept", "program",
  "$@1", "statements", "statement", "declaration", "assignment",
  "expression", "print_stmt", "input_stmt", YY_NULLPTR
};
...
{
       4,   -17,    21,   -17,   -17,     1,   -17,   -13,     7,     9,
      13,   -17,   -17,   -17,   -17,   -17,    25,    23,   -17,   -17,
     -17,    26,     6,   -17,   -17,   -17,     6,     5,   -12,     6,
       6,     6,     6,   -17,    14,    14,   -17,   -17
};
...
{
       0,     2,     0,     5,     1,     0,     3,     0,     0,     0,
       0,     4,     6,     7,     8,     9,     0,     0,    20,    19,
      21,     0,     0,    10,    12,    13,     0,    11,     0,     0,
       0,     0,     0,    18,    14,    15,    16,    17
};
...
{
      29,    30,    31,    32,    16,     6,     7,     1,    33,     8,
      28,     9,    10,    34,    35,    36,    37,    29,    30,    31,
      32,     4,    24,    25,    17,    26,    18,    19,    31,    32,
      20,    21,    22,    23
};

static const yytype_int8 yycheck[] =
{
      12,    13,    14,    15,    17,     4,     5,     3,    20,     8,
      26,    10,    11,    29,    30,    31,    32,    12,    13,    14,
      15,     0,    16,    17,    17,    19,    17,    18,    14,    15,
      17,     6,     9,     7
};
...
{
       0,     3,    22,    23,     0,    24,     4,     5,     8,    10,
      11,    25,    26,    27,    29,    30,    17,    17,    17,    18,
      17,     6,     9,     7,    16,    17,    19,    28,    28,    12,
      13,    14,    15,    20,    28,    28,    28,    28
};
...
#line 1140 "parser.tab.c"
  ...
  case 10: /* declaration: VAR IDENTIFIER AS INT  */
#line 67 "parser.y"
                          { 
...
#line 1149 "parser.tab.c"
  ...
  case 11: /* assignment: SET IDENTIFIER TO expression  */
#line 75 "parser.y"
                                 { 
        printf("    %s = %s;\n", (yyvsp[-2].id), (yyvsp[0].code)); 
    }
...
#line 89 "parser.y"
                                  { (yyval.code) = combine((yyvsp[-2].code), "+", (yyvsp[0].code)); }
...
#line 1187 "parser.tab.c"
  ...
  case 16: /* expression: expression MULT expression  */
#line 91 "parser.y"
                                  { (yyval.code) = combine((yyvsp[-2].code), "*", (yyvsp[0].code)); }
...
#line 93 "parser.y"
                         {
        char* buf = malloc(512);
        sprintf(buf, "(%s)", (yyvsp[-1].code));
        (yyval.code) = buf;
    }
#line 1209 "parser.tab.c"
    break;

  case 19: /* print_stmt: SHOW STRING  */
#line 101 "parser.y"
                { printf("    printf(%%s\\n, %s);\n", (yyvsp[0].id)); }
#line 1215 "parser.tab.c"
    break;

  case 20: /* print_stmt: SHOW IDENTIFIER  */
#line 102 "parser.y"
                      {
        char *type = get_type((yyvsp[0].id));
...
#line 1225 "parser.tab.c"
  ...
  case 21: /* input_stmt: GET IDENTIFIER  */
#line 110 "parser.y"
                   {
        char *type = get_type((yyvsp[0].id));
        if (type && strcmp(type, "int") == 0) 
